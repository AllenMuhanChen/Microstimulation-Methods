...
%Parameters of Pulse
I = 10;        I = I*10^3; %in uA converted to nA.
duration = 100; duration = duration*10^-6; %leading phase in usec converted to sec 
...
fprintf("Reported Max is %d %s",4.45*1000, "uC/cm^2")